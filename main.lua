...
local title = display.newText( uiModGroup, "ap phys 2 mirror sim. (in pixels) [by bowlingfan21317]", 750, display.contentHeight - uiModSizeY + 20, 1000, 35, native.systemFont, 25)
